 ...
 */
@Test
public class SalesForceCustomerTests_IT extends TestNGCitrusTestDesigner {
    ...
    @CitrusTest
    public void getCustomerStatusHit() {
    ...
    @CitrusTest
    public void getCustomerStatusNoHit() {
    	
    	// ******************************************
    	// Specific user status NO HIT
    	// ******************************************
    	http().client(salesforceAPI)
            .send()
            .get()
